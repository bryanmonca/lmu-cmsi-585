let ok,deepEqual,match,throws,fail,randomBytes,change;_7bf‍.w("assert",[["ok",["ok"],function(v){ok=v}],["deepEqual",["deepEqual"],function(v){deepEqual=v}],["match",["match"],function(v){match=v}],["throws",["throws"],function(v){throws=v}],["fail",["fail"],function(v){fail=v}]]);_7bf‍.w("crypto",[["randomBytes",["randomBytes"],function(v){randomBytes=v}]]);_7bf‍.w("../exercises",[["change",["change"],function(v){change=v}]]);
